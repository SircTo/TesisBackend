...
function validarCrear(body = {}) {
  ...
  if (!nombre) throw new ApiError(400, 'El nombre de la zona es obligatorio.');
  ...
  return { nombre, descripcion, estado: body.estado };
}
...
function validarActualizar(body = {}) {
  ...
  if (body.descripcion !== undefined) {
    cambios.descripcion = typeof body.descripcion === 'string' ? body.descripcion.trim() : '';
  }
